...
//Provided code. You may use the class and copy some of the functions to the extended class.
//It is also allowed to add more functions or modify some of the functions in the class
//even though it is not recommended. In this case, add a comment to the code you add or modified.
//Indicate the changes also in the claim spreadsheet.
...
//  	The following function is used for debugging.
	 ...
	 public:
	    ...
	    void  AVL_Traverse (void (*process)(TYPE  dataProc)); //in-order
			...
			//void  AVL_TraverseLName(void (*process)(TYPE dataProc));
	    bool  AVL_Empty    (void);
	    bool  AVL_Full     (void);
	    int   AVL_Count    (void);
